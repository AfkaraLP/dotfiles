...
hl.bind(mod .. " + B",
	hl.dsp.exec_cmd('hyprctl dispatch sendshortcut "CTRL,C,"; ' ..
		vars.shell_commands_path .. '/transform_gemini.nu trump "$(wl-paste)"'))
hl.bind(mod .. " + 3", hl.dsp.exec_cmd(vars.shell_commands_path .. '/get_random_swag.nu "idontgiveaswag"'))
hl.bind(mod .. " + Y",
	hl.dsp.exec_cmd('sh -c \'hyprctl dispatch sendshortcut "CTRL,C," && "' ..
		vars.shell_commands_path .. '/search_dadjoke.nu" "$(wl-paste)" | wl-copy && hyprctl dispatch sendshortcut "CTRL,V,"\''))
hl.bind(mod .. " + 2",
	hl.dsp.exec_cmd('hyprctl dispatch sendshortcut "CTRL,C,"; ' ..
		vars.shell_commands_path .. '/get_random_swag.nu "$(wl-paste)" && hyprctl dispatch sendshortcut "CTRL,V,"'))
hl.bind(mod .. " + 7",
	hl.dsp.exec_cmd('hyprctl dispatch sendshortcut "CTRL,C,"; ' ..
		vars.shell_commands_path .. '/transform_gemini.nu semi "$(wl-pasta)"'))
...
hl.bind("SUPER + ALT + S", hl.dsp.exec_cmd('spotify'))
